...
object Lucide {
    ...
    @Composable fun MoreVertical(modifier: Modifier = Modifier, color: Color = Color.Unspecified, size: Dp = Dp.Unspecified, strokeWidth: Dp = Dp.Unspecified) = Render(Icons.Rounded.MoreVert, modifier, color, size)
    ...
    @Composable fun Upload(modifier: Modifier = Modifier, color: Color = Color.Unspecified, size: Dp = Dp.Unspecified, strokeWidth: Dp = Dp.Unspecified) = Render(Icons.Rounded.Upload, modifier, color, size)
    ...
    @Composable fun RotateCamera(modifier: Modifier = Modifier, color: Color = Color.Unspecified, size: Dp = Dp.Unspecified, strokeWidth: Dp = Dp.Unspecified) = Render(Icons.Rounded.Cameraswitch, modifier, color, size)
    @Composable fun Flashlight(modifier: Modifier = Modifier, color: Color = Color.Unspecified, size: Dp = Dp.Unspecified, strokeWidth: Dp = Dp.Unspecified) = Render(Icons.Rounded.FlashlightOn, modifier, color, size)
